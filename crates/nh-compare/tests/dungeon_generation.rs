...
fn test_different_dungeon_levels() {
    ...
    let level1 = Level::new_generated(DLevel::new(0, 1), &mut rng, &MonsterVitals::default());
    let level5 = Level::new_generated(DLevel::new(0, 5), &mut rng, &MonsterVitals::default());
    let level10 = Level::new_generated(DLevel::new(0, 10), &mut rng, &MonsterVitals::default());
