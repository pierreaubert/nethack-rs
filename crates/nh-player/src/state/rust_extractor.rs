...
impl<'a> RustGameEngine<'a> {
    ...
    pub fn extract_state(&self) -> UnifiedGameState {
        ...
        UnifiedGameState {
            ...
            strength: state
                .player
                .attr_current
                .get(nh_core::player::Attribute::Strength) as i32,
            dexterity: state
                .player
                .attr_current
                .get(nh_core::player::Attribute::Dexterity) as i32,
            constitution: state
                .player
                .attr_current
                .get(nh_core::player::Attribute::Constitution) as i32,
            intelligence: state
                .player
                .attr_current
                .get(nh_core::player::Attribute::Intelligence) as i32,
            wisdom: state
                .player
                .attr_current
                .get(nh_core::player::Attribute::Wisdom) as i32,
            charisma: state
                .player
                .attr_current
    ...
    pub fn step(&mut self, action: &GameAction) -> (f64, String) {
        ...
        let message = match &result {
            nh_core::GameLoopResult::Continue => self
                .game_loop
                .state()
                .messages
                .last()
