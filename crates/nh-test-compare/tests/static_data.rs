...
use nh_test_compare::data::monsters::extract_monster_names;
use nh_test_compare::data::objects::extract_object_names;
use nh_test_compare::data::artifacts::extract_artifact_names;
use nh_test_compare::data::roles::extract_role_names;
...
fn test_monster_names_coverage() {
    ...
    let rust_names: HashSet<String> = nh_data::monsters::MONSTERS
        .iter()
...
fn test_monster_count() {
    let count = nh_data::monsters::MONSTERS.len();
...
fn test_object_names_coverage() {
    ...
    let rust_names: HashSet<String> = nh_data::objects::OBJECTS
        .iter()
...
fn test_object_count() {
    let count = nh_data::objects::OBJECTS.len();
...
fn test_artifact_names_coverage() {
    ...
    let rust_names: HashSet<String> = nh_data::artifacts::ARTIFACTS
        .iter()
...
fn test_role_names_coverage() {
    ...
    let rust_role_names: HashSet<String> = nh_data::roles::ROLES
        .iter()
...
fn test_all_roles_present() {
    ...
    let rust_roles: HashSet<String> = nh_data::roles::ROLES
        .iter()
        .map(|r| r.name.male.to_string())
        .collect();
...
fn test_all_races_present() {
    ...
    let rust_races: HashSet<String> = nh_data::roles::RACES
        .iter()
...
fn test_static_data_summary() {
    ...
    let rust_monsters = nh_data::monsters::MONSTERS.len();
    let rust_objects = nh_data::objects::OBJECTS.len();
    let rust_artifacts = nh_data::artifacts::ARTIFACTS.len();
    let rust_roles = nh_data::roles::ROLES.len();
    let rust_races = nh_data::roles::RACES.len();
