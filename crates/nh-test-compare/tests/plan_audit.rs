...
const NH_CORE_SRC: &str = "/Users/pierre/src/games/nethack-rs-catastrof/crates/nh-core/src";
...
fn audit_0_2_dual_orchestrator_compares_c_vs_rust() {
    ...
    let orchestrator = fs::read_to_string(
        "/Users/pierre/src/games/nethack-rs-catastrof/crates/nh-test-compare/src/orchestrator/mod.rs"
    ).unwrap_or_default();
    ...
    let replay = fs::read_to_string(
        "/Users/pierre/src/games/nethack-rs-catastrof/crates/nh-test-compare/tests/replay_compare.rs"
    ).unwrap_or_default();
...
fn audit_2_1_monster_field_parser() {
    ...
    let parser = fs::read_to_string(
        "/Users/pierre/src/games/nethack-rs/crates/nh-test-compare/src/data/monsters.rs"
    ).unwrap_or_default();
...
fn audit_2_2_object_field_comparison() {
    ...
    let static_data = fs::read_to_string(
        "/Users/pierre/src/games/nethack-rs-catastrof/crates/nh-test-compare/tests/static_data.rs"
    ).unwrap_or_default();
...
fn audit_9_replay_parity() {
    ...
    let convergence = fs::read_to_string(
        "/Users/pierre/src/games/nethack-rs-catastrof/crates/nh-test-compare/tests/convergence_summary.rs"
    ).unwrap_or_default();
